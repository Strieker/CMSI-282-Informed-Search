...
public class Pathfinder {
	...
	public static ArrayList<String> solve(MazeProblem problem) {
		...
		SearchTreeNode initial = new SearchTreeNode(problem.INITIAL_STATE, null, null,
				getHeuristic(problem.INITIAL_STATE, problem.KEY_STATE), 0);
		MazeState GOAL_STATE = getClosestGoal(problem.KEY_STATE, problem);
		SearchTreeNode key = new SearchTreeNode(problem.KEY_STATE, null, null,
				getHeuristic(problem.KEY_STATE, GOAL_STATE), 0);
	 ...
	 * a goal; this goal does not necessarily mean from the current position to one
